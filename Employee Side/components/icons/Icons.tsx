...
export const CogIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19.14 12.94a2 2 0 0 1 0 2.12l-1.1 1.9-1.42.79a2 2 0 0 0-.5 2.83l.8 1.38a2 2 0 0 1-1.73 3l-2-.5a2 2 0 0 0-2.17 1.19l-.7 2.1a2 2 0 0 1-3.46 0l-.7-2.1a2 2 0 0 0-2.17-1.19l-2 .5a2 2 0 0 1-1.73-3l.8-1.38a2 2 0 0 0-.5-2.83l-1.42-.79-1.1-1.9a2 2 0 0 1 0-2.12l1.1-1.9 1.42-.79a2 2 0 0 0 .5-2.83l-.8-1.38a2 2 0 0 1 1.73-3l2 .5a2 2 0 0 0 2.17-1.19l.7-2.1a2 2 0 0 1 3.46 0l.7 2.1a2 2 0 0 0 2.17 1.19l2-.5a2 2 0 0 1 1.73 3l-.8 1.38a2 2 0 0 0 .5 2.83l1.42.79z"></path><circle cx="12" cy="12" r="3"></circle></svg>
);

export const RoadIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19L9 4l11 0l-5 15H4Z"></path><path d="M12 2v20"></path></svg>
);
...
export const SparklesIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3L9.5 8.5L4 11L9.5 13.5L12 19L14.5 13.5L20 11L14.5 8.5L12 3Z" /><path d="M5 21L7 17L9 21" /><path d="M15 21L17 17L19 21" /><path d="M3 12L5 10L3 8" /><path d="M21 12L19 10L21 8" /></svg>
);
...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a4.5 4.5 0 0 0-4.5 4.5v.5a4.5 4.5 0 0 0-4.5 4.5v0a4.5 4.5 0 0 0 4.5 4.5v.5a4.5 4.5 0 1 0 9 0v-.5a4.5 4.5 0 0 0 4.5-4.5v0a4.5 4.5 0 0 0-4.5-4.5v-.5A4.5 4.5 0 0 0 12 2Z"></path><path d="M12 11.5v4"></path><path d="M10 13.5h4"></path><path d="M9 7h.01"></path><path d="M15 7h.01"></path><path d="M6 11h.01"></path><path d="M18 11h.01"></path><path d="M8 17h.01"></path><path d="M16 17h.01"></path></svg>
);

export const ChatBubbleBottomCenterTextIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M4.804 21.644A6.707 6.707 0 014.5 21.25a6.75 6.75 0 01-2.25-5.25V6.75A6.75 6.75 0 019 0h6a6.75 6.75 0 016.75 6.75v3.75a6.75 6.75 0 01-6.75 6.75h-2.168a2.25 2.25 0 00-1.591.659l-2.206 2.206a2.25 2.25 0 01-1.591.659zM10.5 9a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3z" clipRule="evenodd" /></svg>
);

export const PaperAirplaneIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3.478 2.405a.75.75 0 00-.926.94l2.432 7.905H13.5a.75.75 0 010 1.5H4.984l-2.432 7.905a.75.75 0 00.926.94 60.519 60.519 0 0018.445-8.986.75.75 0 000-1.218A60.517 60.517 0 003.478 2.405z" /></svg>
);

export const BotIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8V4H8"></path><rect x="4" y="8" width="8" height="12" rx="2"></rect><path d="M2 14h2"></path><path d="M20 14h2"></path><path d="M15 13v-2a2 2 0 0 0-2-2h-2v4h4Z"></path></svg>
);
...
export const CheckBadgeIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M8.603 3.799A4.49 4.49 0 0112 2.25c1.357 0 2.573.6 3.397 1.549a4.49 4.49 0 013.498 1.307 4.491 4.491 0 011.307 3.497A4.49 4.49 0 0121.75 12c0 1.357-.6 2.573-1.549 3.397a4.49 4.49 0 01-1.307 3.498 4.491 4.491 0 01-3.497 1.307A4.49 4.49 0 0112 21.75a4.49 4.49 0 01-3.397-1.549 4.49 4.49 0 01-3.498-1.307 4.491 4.491 0 01-1.307-3.497A4.49 4.49 0 012.25 12c0-1.357.6-2.573 1.549-3.397a4.49 4.49 0 011.307-3.498 4.491 4.491 0 013.497-1.307zm3.169 7.023a.75.75 0 01.106-1.06l.073-.073a.75.75 0 011.06 1.06l-2.5 2.5a.75.75 0 01-1.134.027l-1.5-1.5a.75.75 0 111.06-1.06l.97.97 1.94-1.94z" clipRule="evenodd" />
    </svg>
);
...
export const ViewColumnsIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18"></path></svg>
);

export const TrophyIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"></path><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"></path><path d="M4 22h16"></path><path d="M10 14.66V17c0 .55-.47.98-.97 1.21_"></path><path d="M14 14.66V17c0 .55.47.98.97 1.21_"></path><path d="M9.69 14c.2-.23.44-.45.71-.65A10 10 0 0 1 12 13a10 10 0 0 1 1.6.35c.27.2.51.42.71.65"></path><path d="M12 13V2l3.4 4-3.4 4"></path></svg>
);